...
就是说, 
- 第一个加载段就从文件开始`0x0h`-`37000h`, 
- 第二个加载段就是`0x46000`-`0xa9b00`, 
- 第三个加载段就是`0x47650`-`0xa9b00`, 240h
- 第四个加载段就是`0x311E8`-`0xa9b00`, F44h
- 第五个加载段就是`0x0`-`0x0`, 
- 第六个加载段就是`0x36F80`-`0xa9b00`, 1080h


![](obsidian/attachments/Pasted%20image%2020260424154204.png)
