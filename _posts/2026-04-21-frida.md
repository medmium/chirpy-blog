...
![](obsidian/attachments/Pasted%20image%2020260424134703.png)
...
![](obsidian/attachments/Pasted%20image%2020260424142753.png)

got表的调用肯定是来源于plt表.. 查看交叉引用..怎么有2个??

![](obsidian/attachments/Pasted%20image%2020260424143937.png)

就看哪个是真的plt表, 先看第一个

![](obsidian/attachments/Pasted%20image%2020260424144016.png)

很明显, 第一个就是真正的plt表, 可是它的位置太靠前了, 我现在不清楚它和位于`0x47650`-`0x47890`的Dynamic段有何关联??

再看看另一个引用

![](obsidian/attachments/Pasted%20image%2020260424144207.png)

哦, 原来`x`查看的交叉引用包括了本身.. 这里就是got表里的函数嘞, 看看HEX的位置长啥样..

![](obsidian/attachments/Pasted%20image%2020260424144602.png)
...
![](obsidian/attachments/Pasted%20image%2020260424150651.png)
...
![](obsidian/attachments/Pasted%20image%2020260424151621.png)
...
![](obsidian/attachments/Pasted%20image%2020260424153603.png)

![](obsidian/attachments/Pasted%20image%2020260424154303.png)

.....

就是说, 
- 第一个加载段就是`0x0h`     -`37000h`, 
![](obsidian/attachments/Pasted%20image%2020260424161948.png)
- 第二个加载段就是`0x46000`-`0xa9b00`, 
![689](obsidian/attachments/Pasted%20image%2020260424154204.png)

现在我才发现, IDA应该是模拟加载了第一段和第二段, 因为HEX中并没有`0x37000`-`0x46000`. 看看文件中这一部分长什么样子..

![](obsidian/attachments/Pasted%20image%2020260424162308.png)

结果全是这样的00填充...那so文件生成时为什么不直接省略掉呢? 不管了..无法深究..

- 第三个加载段就是`0x47650`-`0x47890`,
![](obsidian/attachments/Pasted%20image%2020260424162916.png)
![](obsidian/attachments/Pasted%20image%2020260424162953.png)

那这第三个段真是Dynamic段..

- 第四个加载段就是`0x311E8`-`0x3212c`, 
![](obsidian/attachments/Pasted%20image%2020260424163213.png)
![](obsidian/attachments/Pasted%20image%2020260424163257.png)

- 第五个加载段就是`0x0`       -`0x0`, 
- 第六个加载段就是`0x36F80`-`0x38000`,
![](obsidian/attachments/Pasted%20image%2020260424163326.png)
全是00字节..
